...
Easily extendable jQuery validation plugin.

**NOTE: There is an error with multiselect field validation, see [here](https://github.com/OdinsPlasmaRifle/jquery.gavel/issues/1) for details.**
